...
import com.backend.usersapp.auth.utils.SimpledGrantedAuthorityJsonCreator;
...
public class JwtValidationFilter extends BasicAuthenticationFilter {
  ...
  protected void doFilterInternal(
    ...
    try {
      Claims claims =
          Jwts.parser().verifyWith(SECRET_KEY_TOKEN).build().parseSignedClaims(token).getPayload();
      ...
      Collection<? extends GrantedAuthority> authorities =
          Arrays.asList(
              new ObjectMapper()
                  ...
                  .readValue(
                      claimsAuthorities.toString().getBytes(), SimpleGrantedAuthority[].class));
